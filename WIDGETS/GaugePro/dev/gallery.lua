-- GaugePro - hoja de contraste visual (visual contract sheet).
--
...
local function manifestText(manifest)
  local buf = { "-- GaugePro gallery manifest - generado por dev/gallery.lua\n",
...
local function renderSheet(theme, cases, results, version, cov)
  ...
  text(PAD + 20, y + 30, "GaugePro - hoja de contraste visual", 21, pal.ink,
       "700")
