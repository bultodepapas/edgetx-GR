-- GaugePro audit preview: like dev/preview.lua, but the SVG emitter models the
...
local html = {
  "<!doctype html><meta charset='utf-8'><title>GaugePro audit preview</title>",
  "<style>",
  ...
  "</style>",
  "<h1>GaugePro &mdash; audit preview"
