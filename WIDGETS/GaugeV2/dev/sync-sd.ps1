# Copy the GaugeV2 runtime payload to an SD-card folder (radio or simulator).
#
#   pwsh dev/sync-sd.ps1                       # -> D:\SD\WIDGETS\GaugeV2
#   pwsh dev/sync-sd.ps1 -Destination E:\      # -> E:\WIDGETS\GaugeV2
#
...
$target = Join-Path $Destination "WIDGETS\GaugeV2"
...
Write-Host "GaugeV2 -> $target  ($copied modules, $kb KB)"
