-- GaugeV2 design preview: renders the real widget code against the mock
...
local html = {
  "<!doctype html><meta charset='utf-8'><title>GaugeV2 preview</title>",
  "<style>",
  ...
  "</style>",
  "<h1>GaugeV2 &mdash; rendered from the real object tree (dark / light)</h1>",
  "<div class='grid'>",
}
...
for _, case in ipairs(CASES) do
  ...
  local dark = renderSvg(z, "dark", scale)
  build(z, overrides, value, history)
  local light = renderSvg(z, "light", scale)
