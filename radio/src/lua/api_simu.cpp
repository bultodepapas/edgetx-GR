...
static int luaSimuArmCapture(lua_State* L)
{
  ...
  // Accept FAT-style paths (e.g. /SCREENSHOTS/x.png) and resolve them to host
  // paths through the simu's SD mapping; absolute host paths pass through.
